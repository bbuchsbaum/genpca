...
- **Constraint handling**: Automatic validation and repair of metric
  matrices (PSD enforcement)
...
- Eigen vs Spectra: unit tests assert tight agreement on modest problems
  (sdev within 1e‑6, scores within 1e‑5 up to sign).
